...
export const IssueItem: React.FC<IssueItemProps> = ({ article, index }) => {
  return (
    <article className="p-6 sm:p-8 bg-ivory-paper border border-editorial-border hover:border-gold-muted/60 transition-all duration-200">
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        {article.typeMetadata && (
          <div className="md:text-right pt-2 md:pt-0 shrink-0">
